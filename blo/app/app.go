...
import (
	...
	bloggmodule "blogg/x/blogg"
	bloggmodulekeeper "blogg/x/blogg/keeper"
	bloggmoduletypes "blogg/x/blogg/types"
	// this line is used by starport scaffolding # stargate/app/moduleImport
)

const (
	AccountAddressPrefix = "blogg"
	Name                 = "blogg"
)
...
type App struct {
	*baseapp.BaseApp
	...
	BloggKeeper bloggmodulekeeper.Keeper
...
func New(
	...
	app.BloggKeeper = *bloggmodulekeeper.NewKeeper(
		appCodec,
		keys[bloggmoduletypes.StoreKey],
		keys[bloggmoduletypes.MemStoreKey],
		app.GetSubspace(bloggmoduletypes.ModuleName),
	)
	bloggModule := bloggmodule.NewAppModule(appCodec, app.BloggKeeper, app.AccountKeeper, app.BankKeeper)
...
func initParamsKeeper(appCodec codec.BinaryCodec, legacyAmino *codec.LegacyAmino, key, tkey sdk.StoreKey) paramskeeper.Keeper {
	...
	paramsKeeper.Subspace(bloggmoduletypes.ModuleName)
