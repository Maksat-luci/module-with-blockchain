...
export const MsgCreatePost = {
  encode(message: MsgCreatePost, writer: Writer = Writer.create()): Writer {
    ...
    if (message.approved !== "") {
      writer.uint32(42).string(message.approved);
    }
    if (message.id !== 0) {
...
export class MsgClientImpl implements Msg {
  ...
  CreatePost(request: MsgCreatePost): Promise<MsgCreatePostResponse> {
    ...
    const promise = this.rpc.request("blogg.blogg.Msg", "CreatePost", data);
  ...
  CreateComment(request: MsgCreateComment): Promise<MsgCreateCommentResponse> {
    ...
    const promise = this.rpc.request("blogg.blogg.Msg", "CreateComment", data);
    return promise.then((data) =>
  ...
  DeleteComment(request: MsgDeleteComment): Promise<MsgDeleteCommentResponse> {
    ...
    const promise = this.rpc.request("blogg.blogg.Msg", "DeleteComment", data);
    return promise.then((data) =>
